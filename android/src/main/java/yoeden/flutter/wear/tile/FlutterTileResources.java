...
public class FlutterTileResources {
    public static ListenableFuture<ResourceBuilders.Resources> onResourcesRequest(@NonNull Context context, @NonNull RequestBuilders.ResourcesRequest requestParams) {
